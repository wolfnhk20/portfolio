...
const items = [
  ...
  },
  {
    ...
    org: "AISSMS COE, Pune",
    desc: "Currently pursuing bachelor's degree with CGPA 8.0. Member of Technical Committee.",
  },
  {
    year: "2023",
  ...
  },
  {
    ...
    desc: "Achieved runner-up position at the inter-college technical programming competition.",
  },
];
    ...
    <div className="relative">
      ...
      <div className="space-y-10">
        {items.map((item, i) => (
          ...
          >
            {/* Dot */}
            <div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-primary border-2 border-background z-10 mt-1" />
            <div className={`ml-10 md:ml-0 md:w-5/12 glass rounded-xl p-5 ${i % 2 === 0 ? "md:mr-auto md:pr-8" : "md:ml-auto md:pl-8"}`}>
              <span className="text-primary text-xs font-bold tracking-wider">{item.year}</span>
